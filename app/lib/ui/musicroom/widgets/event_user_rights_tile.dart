...
class EventUserRightsTile extends StatelessWidget {
  final UserModel userData;
  final EventUsersRights userRights;
  final Function updateUserRights;

  const EventUserRightsTile(
          ...
          children: [
            ...
            IconButton(
              ...
              onPressed: () {
                runZonedGuarded(() {
                  var updatedRights =
                      EventUsersRights.fromCollabUserRights(userRights);
                  updatedRights.vote = !updatedRights.vote;
            ...
            IconButton(
              ...
              onPressed: () {
                runZonedGuarded(() {
                  var updatedRights =
                      EventUsersRights.fromCollabUserRights(userRights);
                  updatedRights.edit = !updatedRights.edit;
                  updateUserRights(userData.uid, updatedRights);
                }, (error, stackTrace) {
                  FirebaseCrashlytics.instance.recordError(error, stackTrace);
                });
